...
const MEDICAL_ISOTOPES = {
  ...
  6:  [{ A:11,  status:'established', type:'diagnostic',  modality:'PET',          indications:['prostate','brain'], production:'¹⁴N(p,α)¹¹C · cyclotron', energy:'Eₚ 13→3 MeV (IAEA rec.)' }],
  // N  — N-13 ammonia myocardial perfusion PET
  7:  [{ A:13,  status:'established', type:'diagnostic',  modality:'PET',          indications:['cardiac'], production:'¹⁶O(p,α)¹³N · cyclotron', energy:'Eₚ 16→7 MeV (IAEA rec.)' }],
  // O  — O-15 water perfusion PET (brain / cardiac)
  8:  [{ A:15,  status:'established', type:'diagnostic',  modality:'PET',          indications:['brain','cardiac'], production:'¹⁴N(d,n)¹⁵O · cyclotron', energy:'E_d 8→0 MeV (IAEA rec.)' }],
  // F  — F-18 FDG / PSMA / NaF PET
  9:  [{ A:18,  status:'established', type:'diagnostic',  modality:'PET',          indications:['neuroendocrine','prostate','cardiac','brain','lymphoma','bone'], production:'¹⁸O(p,n)¹⁸F · cyclotron', energy:'Eₚ 16→3 MeV (IAEA rec.)' }],
  // Na — Na-22 (research PET)
  11: [{ A:22,  status:'development', type:'diagnostic',  modality:'PET',          indications:[], production:'²⁴Mg(d,α)²²Na · accelerator', energy:'E_d ~20 MeV (no IAEA rec. dataset)' }],
  // P  — P-32 brachytherapy
  15: [{ A:32,  status:'established', type:'therapy',     modality:'brachytherapy',indications:[], production:'³¹P(n,γ)³²P · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Sc — Sc-43/44 PET, Sc-47 theranostic beta (matched pair with Lu-177-type ligands)
  21: [
    { A:43,  status:'development', type:'diagnostic',  modality:'PET',          indications:[], production:'⁴²Ca(d,n)⁴³Sc · cyclotron', energy:'E_d ~11→4 MeV' },
    { A:44,  status:'development', type:'diagnostic',  modality:'PET',          indications:[], production:'⁴⁴Ca(p,n)⁴⁴Sc · cyclotron; ⁴⁴Ti/⁴⁴Sc generator', energy:'Eₚ 14→8 MeV (IAEA rec.)' },
    { A:47,  status:'development', type:'theranostic', modality:'beta',         indications:['neuroendocrine'], production:'⁴⁷Ti(n,p)⁴⁷Sc · reactor; ⁴⁸Ca(p,2n) accelerator', energy:'fast reactor neutrons; or Eₚ ~30→19 MeV' }
  ],
  // Co — Co-57 imaging marker / flood source (SPECT), Co-60 teletherapy + HDR brachytherapy
  27: [
    { A:57,  status:'established', type:'diagnostic',  modality:'SPECT',        indications:[], production:'⁵⁸Ni(p,2n)⁵⁷Cu→⁵⁷Co · cyclotron', energy:'Eₚ ~30→16 MeV' },
    { A:60,  status:'established', type:'therapy',     modality:'brachytherapy',indications:[], production:'⁵⁹Co(n,γ)⁶⁰Co · reactor', energy:'thermal neutrons (high flux)' }
  ],
  // Cu — Cu-61/62 PET, Cu-64 theranostic PET, Cu-67 therapy beta (Cu theranostic family)
  29: [
    { A:61,  status:'development', type:'diagnostic',  modality:'PET',          indications:['prostate'], production:'⁶¹Ni(p,n)⁶¹Cu · cyclotron', energy:'Eₚ ~13→5 MeV' },
    { A:62,  status:'development', type:'diagnostic',  modality:'PET',          indications:['cardiac'], production:'⁶²Zn/⁶²Cu generator (⁶²Zn ← ⁶³Cu(p,2n))', energy:'generator; parent ⁶²Zn: Eₚ 30→20 MeV' },
    { A:64,  status:'established', type:'theranostic', modality:'PET',          indications:['lymphoma','breast'], production:'⁶⁴Ni(p,n)⁶⁴Cu · cyclotron', energy:'Eₚ 15→9 MeV (IAEA rec.)' },
    { A:67,  status:'development', type:'theranostic', modality:'beta',         indications:['lymphoma','neuroendocrine','prostate'], production:'⁷⁰Zn(p,α)⁶⁷Cu; ⁶⁸Zn(p,2p)⁶⁷Cu · accelerator', energy:'Eₚ 35→15 MeV (p,α); ~70–90 MeV (p,2p)' }
  ],
  // Ga — Ga-67 citrate SPECT (lymphoma / infection), Ga-68 PSMA / DOTATATE PET
  31: [
    { A:67,  status:'established', type:'diagnostic',  modality:'SPECT',        indications:['lymphoma','infection'], production:'⁶⁸Zn(p,2n)⁶⁷Ga · cyclotron', energy:'Eₚ 30→18 MeV (IAEA rec.)' },
    { A:68,  status:'established', type:'diagnostic',  modality:'PET',          indications:['neuroendocrine','prostate'], production:'⁶⁸Ge/⁶⁸Ga generator (⁶⁸Ge ← ⁶⁹Ga(p,2n))', energy:'generator; parent ⁶⁸Ge: Eₚ 29→13 MeV (IAEA rec.)' }
  ],
  // Se — Se-75 SeHCAT bile-acid malabsorption / selenomethionine SPECT
  34: [{ A:75,  status:'established', type:'diagnostic',  modality:'SPECT',        indications:[], production:'⁷⁴Se(n,γ)⁷⁵Se · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Kr — Kr-81m lung ventilation SPECT
  36: [{ A:81,  status:'established', type:'diagnostic',  modality:'SPECT',        indications:['lung'], production:'⁸¹Rb/⁸¹ᵐKr generator (⁸¹Rb ← ⁸²Kr(p,2n))', energy:'generator; parent ⁸¹Rb: Eₚ 30→20 MeV' }],
  // Rb — Rb-82 cardiac PET
  37: [{ A:82,  status:'established', type:'diagnostic',  modality:'PET',          indications:['cardiac'], production:'⁸²Sr/⁸²Rb generator (⁸²Sr ← ⁸⁵Rb(p,4n))', energy:'generator; parent ⁸²Sr: Eₚ 70→40 MeV (IAEA rec.)' }],
  // Sr — Sr-89 bone pain palliation
  38: [{ A:89,  status:'established', type:'therapy',     modality:'beta',         indications:['bone'], production:'⁸⁸Sr(n,γ)⁸⁹Sr · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Y  — Y-86 PET surrogate, Y-90 microspheres / SIRT / DOTATATE
  39: [
    { A:86,  status:'development', type:'diagnostic',  modality:'PET',          indications:['neuroendocrine'], production:'⁸⁶Sr(p,n)⁸⁶Y · cyclotron', energy:'Eₚ 14→7 MeV (IAEA rec.)' },
    { A:90,  status:'established', type:'therapy',     modality:'brachytherapy',indications:['liver','neuroendocrine'], production:'⁹⁰Sr/⁹⁰Y generator (⁹⁰Sr fission product)', energy:'generator (⁹⁰Sr from fission)' }
  ],
  // Zr — Zr-89 immuno-PET
  40: [{ A:89,  status:'established', type:'diagnostic',  modality:'PET',          indications:[], production:'⁸⁹Y(p,n)⁸⁹Zr · cyclotron', energy:'Eₚ 14→9 MeV (IAEA rec.)' }],
  // Tc — Tc-99m (world's most used diagnostic)
  43: [{ A:99,  status:'established', type:'diagnostic',  modality:'SPECT',        indications:['bone','cardiac'], production:'⁹⁹Mo/⁹⁹ᵐTc generator (⁹⁹Mo ← ²³⁵U fission)', energy:'generator (⁹⁹Mo fission); or Eₚ 22→10 MeV (¹⁰⁰Mo(p,2n), IAEA rec.)' }],
  // Pd — Pd-103 LDR brachytherapy seeds (prostate)
  46: [{ A:103, status:'established', type:'therapy',     modality:'brachytherapy',indications:['prostate'], production:'¹⁰²Pd(n,γ)¹⁰³Pd · reactor; ¹⁰³Rh(p,n) cyclotron', energy:'thermal neutrons; or Eₚ 18→8 MeV (¹⁰³Rh(p,n))' }],
  // In — In-111 Octreoscan SPECT
  49: [{ A:111, status:'established', type:'diagnostic',  modality:'SPECT',        indications:['neuroendocrine'], production:'¹¹²Cd(p,2n)¹¹¹In · cyclotron', energy:'Eₚ 25→16 MeV (IAEA rec.)' }],
  // Sn — Sn-117m conversion-electron therapy (bone pain, atherosclerotic plaque)
  50: [{ A:117, status:'development', type:'therapy',     modality:'beta',         indications:['bone'], production:'¹¹⁶Sn(n,γ) / ¹¹⁷Sn(n,n′γ)¹¹⁷ᵐSn · reactor', energy:'reactor neutrons (thermal + fast inelastic)' }],
  // I  — I-123 SPECT, I-124 immuno-PET, I-125 brachytherapy seeds, I-131 theranostic thyroid
  53: [
    { A:123, status:'established', type:'diagnostic',  modality:'SPECT',        indications:['thyroid'], production:'¹²⁴Xe(p,2n)¹²³Xe→¹²³I · cyclotron', energy:'Eₚ 30→23 MeV (IAEA rec.)' },
    { A:124, status:'development', type:'diagnostic',  modality:'PET',          indications:['thyroid'], production:'¹²⁴Te(p,n)¹²⁴I · cyclotron', energy:'Eₚ 12→8 MeV (IAEA rec.)' },
    { A:125, status:'established', type:'therapy',     modality:'brachytherapy',indications:['prostate'], production:'¹²⁴Xe(n,γ)¹²⁵Xe→¹²⁵I · reactor', energy:'thermal neutrons (~0.025 eV)' },
    { A:131, status:'established', type:'theranostic', modality:'beta',         indications:['thyroid'], production:'¹³⁰Te(n,γ)¹³¹Te→¹³¹I · reactor; ²³⁵U fission', energy:'thermal neutrons (reactor)' }
  ],
  // Xe — Xe-133 lung ventilation / cerebral blood flow SPECT
  54: [{ A:133, status:'established', type:'diagnostic',  modality:'SPECT',        indications:['lung','brain'], production:'²³⁵U fission · reactor', energy:'thermal neutrons (fission)' }],
  // Cs — Cs-131 LDR brachytherapy seeds (prostate / brain)
  55: [{ A:131, status:'established', type:'therapy',     modality:'brachytherapy',indications:['prostate','brain'], production:'¹³⁰Ba(n,γ)¹³¹Ba→¹³¹Cs · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Sm — Sm-153 bone pain
  62: [{ A:153, status:'established', type:'therapy',     modality:'beta',         indications:['bone'], production:'¹⁵²Sm(n,γ)¹⁵³Sm · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Tb — the "Swiss-army" theranostic quartet: 149 alpha, 152 PET, 155 SPECT, 161 beta
  65: [
    { A:149, status:'development', type:'therapy',     modality:'alpha',        indications:[], production:'¹⁴¹Pr(¹²C,4n) / spallation + mass separation · accelerator', energy:'high-energy protons ~0.6–1.4 GeV (spallation); or ¹²C beam' },
    { A:152, status:'development', type:'diagnostic',  modality:'PET',          indications:[], production:'¹⁵²Gd(p,n) / spallation · accelerator', energy:'Eₚ ~10 MeV; or spallation ~1 GeV' },
    { A:155, status:'development', type:'diagnostic',  modality:'SPECT',        indications:[], production:'¹⁵⁵Gd(p,n)¹⁵⁵Tb · cyclotron; spallation', energy:'Eₚ ~10 MeV; or spallation' },
    { A:161, status:'development', type:'theranostic', modality:'beta',         indications:['neuroendocrine','prostate'], production:'¹⁶⁰Gd(n,γ)¹⁶¹Gd→¹⁶¹Tb · reactor', energy:'thermal neutrons (high flux)' }
  ],
  // Dy — Dy-165 radiation synovectomy
  66: [{ A:165, status:'established', type:'therapy',     modality:'synovectomy',  indications:[], production:'¹⁶⁴Dy(n,γ)¹⁶⁵Dy · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Ho — Ho-166 TARE liver / microspheres
  67: [{ A:166, status:'established', type:'therapy',     modality:'brachytherapy',indications:['liver'], production:'¹⁶⁵Ho(n,γ)¹⁶⁶Ho · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Er — Er-169 radiation synovectomy
  68: [{ A:169, status:'established', type:'therapy',     modality:'synovectomy',  indications:[], production:'¹⁶⁸Er(n,γ)¹⁶⁹Er · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Lu — Lu-177 PSMA-617 / DOTATATE (fastest growing)
  71: [{ A:177, status:'established', type:'theranostic', modality:'beta',         indications:['neuroendocrine','prostate'], production:'¹⁷⁶Lu(n,γ)¹⁷⁷Lu (direct); ¹⁷⁶Yb(n,γ)¹⁷⁷Yb→¹⁷⁷Lu (c.a.) · reactor', energy:'thermal neutrons (high flux ≥10¹⁴ n·cm⁻²·s⁻¹)' }],
  // Re — Re-186 / Re-188 bone / liver
  75: [
    { A:186, status:'established', type:'therapy',     modality:'beta',         indications:['bone'], production:'¹⁸⁵Re(n,γ)¹⁸⁶Re · reactor', energy:'thermal neutrons (~0.025 eV)' },
    { A:188, status:'established', type:'therapy',     modality:'beta',         indications:['bone','liver'], production:'¹⁸⁸W/¹⁸⁸Re generator (¹⁸⁸W ← double n-capture on ¹⁸⁶W)', energy:'generator; ¹⁸⁸W via very high thermal flux' }
  ],
  // Ir — Ir-192 HDR brachytherapy (most common HDR source)
  77: [{ A:192, status:'established', type:'therapy',     modality:'brachytherapy',indications:['prostate','breast'], production:'¹⁹¹Ir(n,γ)¹⁹²Ir · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Au — Au-198 brachytherapy (beta/gamma seeds)
  79: [{ A:198, status:'established', type:'therapy',     modality:'brachytherapy',indications:[], production:'¹⁹⁷Au(n,γ)¹⁹⁸Au · reactor', energy:'thermal neutrons (~0.025 eV)' }],
  // Tl — Tl-201 cardiac SPECT
  81: [{ A:201, status:'established', type:'diagnostic',  modality:'SPECT',        indications:['cardiac'], production:'²⁰³Tl(p,3n)²⁰¹Pb→²⁰¹Tl · cyclotron', energy:'Eₚ 28→20 MeV (IAEA rec.)' }],
  // Pb — Pb-203 SPECT imaging surrogate, Pb-212 Pb-DOTAMTATE alpha cascade (matched pair)
  82: [
    { A:203, status:'development', type:'diagnostic',  modality:'SPECT',        indications:['neuroendocrine','prostate'], production:'²⁰⁵Tl(p,3n)²⁰³Pb · cyclotron', energy:'Eₚ ~28→20 MeV' },
    { A:212, status:'development', type:'therapy',     modality:'alpha',        indications:['neuroendocrine','prostate'], production:'²²⁴Ra/²¹²Pb generator (²²⁸Th decay chain)', energy:'generator (²²⁸Th/²²⁴Ra decay)' }
  ],
  // Bi — Bi-212 / Bi-213 alpha TAT
  83: [
    { A:212, status:'development', type:'therapy',     modality:'alpha',        indications:[], production:'²²⁴Ra→²¹²Pb→²¹²Bi generator', energy:'generator (²²⁴Ra decay)' },
    { A:213, status:'development', type:'therapy',     modality:'alpha',        indications:[], production:'²²⁵Ac/²¹³Bi generator', energy:'generator (²²⁵Ac decay)' }
  ],
  // At — At-211 alpha TAT
  85: [{ A:211, status:'development', type:'therapy',     modality:'alpha',        indications:[], production:'²⁰⁹Bi(α,2n)²¹¹At · cyclotron', energy:'E_α 28→21 MeV (IAEA rec.; <28.5 to avoid ²¹⁰At)' }],
  // Ra — Ra-223 dichloride bone mets (first approved alpha therapy)
  88: [{ A:223, status:'established', type:'therapy',     modality:'alpha',        indications:['bone'], production:'²²⁷Ac→²²⁷Th→²²³Ra (²²⁷Ac from ²²⁶Ra(n,γ))', energy:'decay chain (²²⁷Ac bred via thermal neutrons)' }],
  // Ac — Ac-225 PSMA alpha TAT
  89: [{ A:225, status:'development', type:'therapy',     modality:'alpha',        indications:['prostate'], production:'²²⁹Th/²²⁵Ac generator; ²²⁶Ra(p,2n) accelerator', energy:'generator (²²⁹Th decay); or Eₚ 16→6 MeV (²²⁶Ra(p,2n))' }],
  // Th — Th-227 targeted thorium conjugates (alpha TAT)
  90: [{ A:227, status:'development', type:'therapy',     modality:'alpha',        indications:['prostate','breast'], production:'²²⁷Ac→²²⁷Th (from ²²⁷Ac decay)', energy:'decay (²²⁷Ac → ²²⁷Th)' }],
};
  ...
  if (prodIsos.length > 0) {
    html += `
      <div class="detail-card production-card">
        <h3>Production route <span class="src-tag">IAEA-NDS recommended</span></h3>
        ${prodIsos.map(m => `
          <div class="prod-row">
            <span class="prod-iso">${el.symbol}-${m.A}</span>
            <div class="prod-detail">
              <span class="prod-rxn">${m.production}</span>
              ${m.energy ? `<span class="prod-energy"><span class="prod-energy-label">Irradiation</span>${m.energy}</span>` : ''}
            </div>
          </div>
        `).join('')}
        <div class="prod-note">&ldquo;Eₚ A→B MeV (IAEA rec.)&rdquo; = IAEA-recommended optimum incident-energy window (entrance→exit on target), per IAEA-TECDOC-1211/1340 &amp; the 2019 IAEA-NDS update. Reactor (n,γ)/fission routes use thermal neutrons (~0.025 eV) — no IAEA beam energy; generator/decay routes list the parent's production energy.</div>
      </div>
    `;
  }
